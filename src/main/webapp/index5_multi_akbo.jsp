                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                         ...
                                         <td>
                                                    ...
                                                    <a class = "btn"  href="C:\Users\SM2104\Desktop\3차프로젝트\front\pdf\akbo.pdf" data-toggle="tooltip" title="pdf 다운받기" download> <img src = "${path}/img/pdf.png" width=25px, height=25px> </a>
                                                    <br>
                                                    <a  class = "btn"  href="#" data-toggle="tooltip" title="연습하기!"> <img src = "${path}/img/practice.png" width = 25px, height = 25px></a>
                                                    <br>
                                                    <a  class = "btn"  href="#" data-toggle="tooltip" title="다른 곡 선택하기!"> <img src = "${path}/img/back.png" width = 25px, height = 25px></a>
